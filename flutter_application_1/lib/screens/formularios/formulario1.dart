...
class Formulario1Screen extends StatefulWidget {
  const Formulario1Screen({super.key});

  @override
  // ignore: library_private_types_in_public_api
  _Formulario1ScreenState createState() => _Formulario1ScreenState();
}

class _Formulario1ScreenState extends State<Formulario1Screen> {
